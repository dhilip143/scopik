  ...
  return (
    <div>
      <div className="relative cursor-pointer">
        ...
        <div className="absolute -top-14 bg-gradient-to-r from-[#23A4DC] to-[#084E90] w-[1280px] h-[180px] mx-[110px] rounded-lg flex justify-between items-center px-10">
          <h1 className="text-white w-[500px] font-meri text-lg">
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 flex flex-col items-center w-[90%] mt-10">
          ...
          <div className="flex justify-evenly items-start w-full">
            <div>
              <img src={logo} className="w-24" alt="Logo" onClick={openAdmin} />
            </div>
            ...
            <div className="w-full max-w-[900px]">
              <table className="w-full">
                ...
                <tbody>
                  <tr>
                    <td className="text-[#414141]"><Link to="/">Home</Link></td>
                  ...
                  <tr>
                    <td className="text-[#414141]"><Link>About Us</Link></td>
                    <td className="text-[#414141]">+91 23744 29424</td>
                    <td></td>
                    <td className="text-[#414141]">Madipakkam, Chennai,</td>
                  </tr>
                  <tr>
                    <td className="text-[#414141]"><Link to="/course">Courses</Link></td>
                    <td></td>
                    <td></td>
